/**
 *  Pushover (device handler)
 *
 *  Copyright 2014 Alex Malikov (original)
 *  Copyright 2015-2016 Kevin Shuk (recast)
 *
 ...
 *
 * Not even close to done. Hell I haven't even started what I plan to do here.
 */
...
metadata {
	definition (name: "Pushover device", namespace: "surfous", author: "Kevin Shuk") {
